...
String Riddle2 = JOptionPane.showInputDialog("What has a foot but no legs"); 
if (Riddle2.equals("a Snail")) {
	JOptionPane.showMessageDialog(null, "Correct");
} else {
	 JOptionPane.showMessageDialog(null, "Wrong it was a Snail");
}
		// 6. Add some more riddles
		String secondR = JOptionPane
				.showInputDialog("the house with red bricks is a red house, the the house with blue bricks is a blue house what is a house made of glass called");
